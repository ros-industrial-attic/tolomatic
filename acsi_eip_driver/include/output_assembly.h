...
typedef enum {
  ...
  INC_POSITIVE = 1,     // Moves in the positive direction the distance specified by
                        // Target 0 Position at the defined motion profile
  INC_NEGATIVE = 2,     // Moves in the negative direction the distance specified by
                        // Target 0 Position at the defined motion profile
...
public:
   ...
   */
  virtual size_t getLength() const { return 32; }
  /**
